...
const LoginComponent = () => {
    ...
    const handleClickLogin = (e) => {
        ...
        .then(data => {
            ...
            console.log(data)   // 로그인 성공후 나온 로그값 : email, social, nickname, pw, accwssToken, refreshToken, roleNames
            if(data.error){ // 로그인 실패시
        ...
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <input className="w-full p-3 rounded-r border border-soild border-neutral-500 shadow-md"
                        name = "email"
                        type = {'text'}
